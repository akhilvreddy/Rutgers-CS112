...
public class Driver {
    ...
    public static void main (String[] args) {
        ...
        String[] methods = {"one-argument constructor", "three-argument constructor", "showOriginalPicture", 
        "showCollagePicture", "makeCollage", "replaceTile", "colorizeTile", "grayscaleTile"};
    ...
    private static void executeGrayscaleTile (Collage c) {
        ...
        if ( col >= c.getCollageDimension() ) {
            System.out.println("Aborting, the column entered is greater than " + c.getCollageDimension());
            return;
        }
    ...
    private static void executeColorizeTile (Collage c) {
        ...
        int row = StdIn.readInt();
        if ( row >= c.getCollageDimension() ) {
            System.out.println("Aborting, the row entered is greater than " + c.getCollageDimension());
            return;
        }
